...
namespace MarsFramework.Global
{
    class GlobalDefinitions
    {
        ...
        {
            WebDriverWait wait = new WebDriverWait(GlobalDefinitions.driver, TimeSpan.FromSeconds(3));
        ...
        {
            IJavaScriptExecutor js = (IJavaScriptExecutor)GlobalDefinitions.driver;
